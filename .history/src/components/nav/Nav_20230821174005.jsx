...
const Nav = () => {
  ...
  return (
    <div className="nav">
      ...
      <a href="#      <a href="#services" className={activeNav === '#services' ? 'active' : ''} onClick={() => setActiveNAv('#services')}><BsBagDash /></a>
" className={activeNav === '#services' ? 'active' : ''} onClick={() => setActiveNAv('#services')}><BsBagDash /></a>
